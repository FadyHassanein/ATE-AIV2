...
from database_connection import db  # Import the database connection from your database_connection module
import re

# Initialize Tavily client with your API key
tavily_client= TavilyClient(api_key="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")
...
def test_database_schema():
    ...
    try:
        ...
        if db is not None:
            ...
            result = db.run("SELECT TOP 5 DISTINCT CompanyName FROM quotesresponses")
            return True
    except Exception as e:
